ROOT_DIR="/home/anton/Programming/AnimeDetect++/deploy"
...
zip \
	...
	"$ROOT_DIR/objs/test.png" \
	"$ROOT_DIR/objs/test.jpg" \
...
ssh -i "$SSH_KEY" ec2-user@$INSTANCE_IP <<ENDSSH
	...
	python3 -c "import classify; classify.test()"
